...
def endSor(word):
	...
	for x in range(len(dat)):
		for y in range(len(dat[x])):
			if word[len(word)-len(dat[x][y][1]):] == dat[x][y][1]:
...
def login():
	...
	nounadj_button = driver.find_element(By.XPATH, '/html/body/div[1]/div[2]/ul[3]/li[4]/div/ul/li[9]/a')
...
window = Tk()
window.title('Better than Kate bot V7')
